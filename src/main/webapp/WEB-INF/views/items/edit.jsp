...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="d-flex align-items-center">
                        <a href="/items" class="btn btn-outline-secondary btn-back">
                            <i class="fas fa-arrow-left"></i> Back
                        </a>
                        <h1 class="mb-0">Edit Food Item</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <form id="editItemForm">
                        <input type="hidden" id="itemId" name="foodItemId">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (!itemId) {
                alert("No item ID provided. Redirecting to items list.");
            ...
            function fetchItemData(id) {
                fetch(`/api/food-items/${id}`)
                    ...
                    .then(data => {
                        ...
                        itemIdInput.value = data.foodItemId || "";
                    ...
                    .catch(error => {
                        ...
                        alert("Failed to load food item data. Redirecting to items list.");
                        window.location.href = "/items";
                    });
            }
            
            // Update food item using fetch API
            function updateFoodItem(foodItem) {
                fetch(`/api/food-items/${foodItem.foodItemId}`, {
                    method: "PUT",
                    headers: {
